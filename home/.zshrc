...
alias update='update_nvim ; brew upgrade; brew update; brew cleanup; update_dotfiles_submodules; $HOME/.local/share/aerospace-swipe/install.sh; update_nvim_plugins'
