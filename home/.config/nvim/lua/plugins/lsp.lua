...
local function kind__3eicon(kind)
  local icons = {Variable = "\238\170\136", Function = "\238\170\140", Class = "\238\173\155", Text = "\238\170\145", Keyword = "\238\173\162", Snippet = "\238\173\166", Module = "\238\170\139", Reference = "\238\170\148", Method = "\238\170\140", Constant = "\238\173\157"}
  local icon
  do
    local t_1_ = icons
    if (nil ~= t_1_) then
