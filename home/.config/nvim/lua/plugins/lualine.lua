...
ins_left({_5_, color = {fg = colors.blue}, padding = {left = 0, right = 1}})
local mode
local function _6_()
  return "\239\140\140"
end
...
mode = {_6_, color = _7_, padding = {right = 1}}
ins_left(mode)
...
ins_left({_8_})
ins_left({lsp_connection_evil, icon = "\239\130\133 LSP:", color = {fg = "#ffffff", gui = "bold"}})
...
ins_right({_9_, color = {fg = colors.blue}, padding = {left = 1}})
...
local my_setup = {options = {theme = "tokyonight", icons_enabled = true, globalstatus = true, always_show_tabline = false}, winbar = {lualine_a = {}}, tabline = {lualine_a = {{"tabs", mode = 2, path = 1}}}, inactive_winbar = {lualine_a = {}}, disabled_filetypes = {statusline = {}, winbar = {}}, sections = {lualine_a = {{"mode"}}, lualine_b = {{"branch", icon = "\239\145\191"}}, lualine_c = {"diff", {"diagnostics", sections = {"error", "warn", "info", "hint"}, sources = {"nvim_lsp"}}, {lsp_connection_evil}, {"filename", file_status = true, path = 1, shorting_target = 40}, "navic"}, lualine_x = {"filetype"}, lualine_y = {"progress"}, lualine_z = {"location"}}, inactive_sections = {lualine_a = {}, lualine_b = {}, lualine_c = {{"filename", file_status = true, path = 1}}, lualine_x = {}, lualine_y = {}, lualine_z = {}}, extensions = {"neo-tree", "oil", "nvim-dap-ui", "fugitive", "aerial", "quickfix", "lazy", "mason"}}
local function _13_()
  local lualine = require("lualine")
  return lualine.setup(my_setup)
end
return {{"nvim-lualine/lualine.nvim", config = _13_}}
