...
nvim.o.mouse = "a"
do
  local options = {encoding = "utf-8", spelllang = "en_us", errorbells = true, relativenumber = true, number = true, completeopt = "menuone,noselect", wildmenu = true, wildignore = "*/tmp/*,*.so,*.swp,*.zip", ignorecase = true, smartcase = true, clipboard = "unnamedplus", listchars = str.join(",", {"tab:\226\150\182-", "trail:\226\128\162", "extends:\194\187", "precedes:\194\171", "eol:\194\172"}), expandtab = true, tabstop = 4, shiftwidth = 4, softtabstop = 4, undofile = true, splitbelow = true, splitright = true, hlsearch = true, signcolumn = "yes", foldlevel = 1, shell = "nu", showbreak = "\226\134\179", textwidth = 80, breakindent = true, breakindentopt = "shift:4,sbr", cursorline = true, foldmethod = "expr", foldexpr = "v:lua.vim.treesitter.foldexpr()", foldtext = "", laststatus = 3, backup = false, foldenable = false, list = false, showmode = false, swapfile = false}
