...
nvim.o.mouse = "a"
do
  local options = {encoding = "utf-8", spelllang = "en_us", colorcolumn = "80", errorbells = true, relativenumber = true, completeopt = "menuone,noselect", wildmenu = true, wildignore = "*/tmp/*,*.so,*.swp,*.zip", ignorecase = true, smartcase = true, clipboard = "unnamedplus", listchars = str.join(",", {"tab:\226\150\182-", "trail:\226\128\162", "extends:\194\187", "precedes:\194\171", "eol:\194\172"}), expandtab = true, tabstop = 4, shiftwidth = 4, softtabstop = 4, undofile = true, splitbelow = true, splitright = true, hlsearch = true, signcolumn = "yes", foldmethod = "syntax", shell = "zsh", showbreak = "\226\134\179", breakindent = true, breakindentopt = "shift:4,sbr", cursorline = true, backup = false, list = false, showmode = false, swapfile = false}
