...
set("n", "<leader>qn", "<cmd>cnext<CR>zz", { desc = 'Next quickfix list entry' })
set("n", "<leader>qp", "<cmd>cprev<CR>zz", { desc = 'Previous quickfix list entry' })
...
set({ "n", "i", "v" }, "<C-M-s>", function()
  vim.cmd("wa")
  vim.notify("All buffers saved")
