...
let g:sexp_mappings = {
    ...
    \ 'sexp_emit_head_element': '<C-S-j>',
    \ 'sexp_emit_tail_element': '<C-S-k>',
    \ 'sexp_capture_prev_element': '<C-S-h>',
    \ 'sexp_capture_next_element': '<C-S-l>',
    \ 'sexp_swap_list_backward': '<C-M-k>',
    \ 'sexp_swap_list_forward': '<C-M-j>',
    \ 'sexp_swap_element_backward': '<C-M-h>',
    \ 'sexp_swap_element_forward': '<C-M-l>',
    \ 'sexp_raise_list': '<M-o>',
