...
let g:sexp_mappings = {
    ...
    \ 'sexp_emit_head_element': '<C-M-j>',
    \ 'sexp_emit_tail_element': '<C-M-k>',
    \ 'sexp_capture_prev_element': '<C-M-h>',
    \ 'sexp_capture_next_element': '<C-M-l>',
    \ 'sexp_swap_list_backward': '<C-S-k>',
    \ 'sexp_swap_list_forward': '<C-S-j>',
    \ 'sexp_swap_element_backward': '<C-S-h>',
    \ 'sexp_swap_element_forward': '<C-S-l>',
    \ 'sexp_raise_list': '<M-o>',
