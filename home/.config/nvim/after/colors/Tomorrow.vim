highlight VertSplit guibg=Gray ctermbg=248
highlight StatusLine gui=bold guibg=#4271ae guifg=White cterm=bold ctermbg=25 ctermfg=255
highlight StatusLineNC gui=bold guibg=Gray guifg=White cterm=bold ctermbg=248 ctermfg=255
highlight CtrlPMode1 gui=bold guibg=White  guifg=#4271ae cterm=bold ctermbg=255 ctermfg=25
highlight CtrlPMode2 gui=bold guibg=#8959a8 guifg=White cterm=bold ctermbg=97 ctermfg=255
