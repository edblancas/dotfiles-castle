...
set("n", "<C-S-k>", "<cmd>cnext<CR>zz", { desc = 'Next quickfix list' })
set("n", "<C-S-j>", "<cmd>cprev<CR>zz", { desc = 'Previous quickfix list' })
set("n", "<leader>k", "<cmd>lnext<CR>zz", { desc = 'Next location list' })
set("n", "<leader>j", "<cmd>lprev<CR>zz", { desc = 'Previous location list' })
