...
local function _1_()
  ...
  lspconfig.fennel_ls.setup({capabilities = capabilities, single_file_support = true, root_dir = lspconfig.util.root_pattern("fnl"), settings = {fennel = {diagnostics = {globals = {"vim"}}, workspace = {library = vim.api.nvim_get_runtime_file("", true), maxPreload = 1000, preloadFileSize = 1000}}}, before_init = before_init, on_attach = on_attach, handlers = handlers})
